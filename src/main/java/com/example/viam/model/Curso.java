...
public class Curso {
    ...
    @Builder
    public Curso(Long id, String titulo, String slug, String descripcion, String urlImagen, List<String> temas,
                 Usuario instructor, Date fechaCreacion, Nivel nivel, Integer duracionHoras,
                 Integer puntajeMaximo, EstadoCurso estado) {
        this.id = id;
        this.titulo = titulo;
        this.slug = slug;
    ...
    @ElementCollection
    @CollectionTable(name = "curso_temas", joinColumns = @JoinColumn(name = "curso_id"))
